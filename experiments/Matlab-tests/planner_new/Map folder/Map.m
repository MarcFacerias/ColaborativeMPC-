            ...
            for i = 1:size(spec,1)
                if spec(i, 2) == 0.0                % If the current segment is a straight line
                    ...
                    if i == 1
                        ...
                        ang = PointAndTangent(i - 1, 3);                              % Angle of the tangent vector at the
                                                                                      % starting point of the segment
...
%             self.TrackLength = PointAndTangent(end, 4);  
        ...
        function [ x, y, theta ] = getGlobalPosition( self, s, ey )
...
%                 theta = angle + direction * spanAng;
        ...
        function [ s, ey, epsi ] = getLocalPosition( self, x, y, psi )
