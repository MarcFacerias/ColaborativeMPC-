function [ controller ] = LPV_MPC_fnc_dt_Vnew( Hp, dt )

x       = sdpvar(5,Hp+1,'full');    % [vx, vy, w, ey, etheta, t]
u       = sdpvar(2,Hp,'full');      % [delta, acceleration]
pastu   = sdpvar(2, 1,'full');
curv    = sdpvar(1,Hp+1,'full'); 
sc      = sdpvar(1,Hp+1,'full'); 
