...
% just loading variables into an object 
...
% parse from containers into variables for usability 
nx = ModelParams.nx;
nu = ModelParams.nu;
N = MPC_vars.N;
Ts = MPC_vars.Ts;
...
% functions used to adapt the car to the track size, we need a safety
% margin in the edges 
safteyScaling = 1.5;
