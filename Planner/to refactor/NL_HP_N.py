...
from Planner.planners.nonLinDistribPlanner import PlannerHp
...
class agent(initialiserNL_HP):
    ...
    def __init__(self, N, Map, dt, x0, id, dth):
        ...
        self.N = N
        self.x0 = x0
        self.Controller = PlannerHp(self.Q,self.Qs, self.R, N, dt, Map, id, dth, self.model_param, self.sys_lim)
        self.states = []
        self.u = []
        self.time_op = []
        self.status = []
